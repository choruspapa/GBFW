...
namespace Eland.GBFW.Win.Shell.Advice
{
    public class ClientSoapExtension : Formular.Support.Extension.HeaderTransfer.WebService.ClientSoapExtension
    {
        ...
        public override void ConnectionChanged(string oldIpAddress, string oldHostName, string newIpAddress, string newHostName)
        {
            if (_service == null) return;
            _service.ConnectionChanged(oldIpAddress, oldHostName, newIpAddress, newHostName);
        }
