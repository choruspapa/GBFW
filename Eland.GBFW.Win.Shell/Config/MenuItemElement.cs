...
namespace Eland.GBFW.Win.Shell.Config
{
    public class MenuItemElement : ConfigurationElement
    {
        ...
        public System.Drawing.Image GetIcon(string iconName)
        {
            ResourceManager resourceMan = new ResourceManager(typeof(Eland.GBFW.Win.Common.Properties.Resources));
